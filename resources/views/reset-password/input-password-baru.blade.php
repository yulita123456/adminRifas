        ...
        <div class="card">           
            ...
            <form action="{{ route('reset.password.post') }}" method="post">
                ...
                <div class="mb-4">
                    ...
                    <input type="password" class="form-control" id="exampleInputPassword" aria-describedby="emailHelp" style="background: rgba(235, 239, 184, 0.756)" placeholder="Masukan password baru" name="password" required>
                </div>
